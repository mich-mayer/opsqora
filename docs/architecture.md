...
- `src/App.tsx`: main application shell, navigation, screens, filters, review interactions, charts, and UI components.
...
- `src/types.ts`: domain types for tickets, AI analysis, review status, priorities, and pages.
- `src/styles.css`: global styling for the app and case study.

This compact structure is intentional for the Phase 1 prototype. If the app grows, prefer gradual extraction by product surface:
